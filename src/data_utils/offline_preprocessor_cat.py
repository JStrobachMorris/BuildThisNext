...
min_success = success_raw.min()
is_min = success_raw == min_success
non_min_success = success_raw[~is_min]
binned_non_min = pd.qcut(non_min_success, q=2, labels=[1, 2])
success_binned = pd.Series(index=success_raw.index, dtype=int)
